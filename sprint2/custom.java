...
public class custom extends BaseAdapter{
    ...
    public custom(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c, ArrayList<String> d, ArrayList<String> e, ArrayList<String> f) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom, null);
        ...
        TextView tv5=(TextView)gridView.findViewById(R.id.textView47);
        TextView tv6=(TextView)gridView.findViewById(R.id.textV);
