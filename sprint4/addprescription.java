...
public class addprescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+sh.getString("ip", "")+":5000/addprescription";
...
//            intent.setType("application/pdf");
    ...
    private void uploadBitmap(final String title) {
        pd = new ProgressDialog(addprescription.this);
...
//                        Toast.makeText(Upload_agreement.this, "Report Sent Successfully", Toast.LENGTH_LONG).show();
                            if (obj.getString("task").equalsIgnoreCase("success")) {
                                ...
                                Toast.makeText(addprescription.this, "Successfully uploaded", Toast.LENGTH_LONG).show();
                                Intent i = new Intent(getApplicationContext(), doctor_home.class);
                                startActivity(i);
                            } else {
